...
public class PostgresqlExample {
   ...
   public static void main(String[] var0) throws ClassNotFoundException {
      try {
         Connection var1 = DriverManager.getConnection("jdbc:postgresql://pg-3125bdee-dbb-ecommerce.c.aivencloud.com:12644/defaultdb?ssl=require&user=avnadmin&password=AVNS_t8n-cE6ZnWlK3T-4XeJ");
